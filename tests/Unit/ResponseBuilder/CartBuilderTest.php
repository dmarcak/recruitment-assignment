...
class CartBuilderTest extends TestCase
{
    ...
    {
        $cart = new Cart('3db5f857-e5a3-4c8d-a262-37da156c0001');
        $cart->addProduct(new Product('16e0226c-0ed8-434a-9342-429aefeb98f0', 'Product 1', 1990, new DateTimeImmutable('2023-03-07 14:25:01')));
        $cart->addProduct(new Product('5884ad4c-9ac2-40a5-ba11-1a96156c5889', 'Product 2', 3690, new DateTimeImmutable('2023-03-07 14:25:02')));
